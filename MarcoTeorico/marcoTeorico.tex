...
\textbf{Step 2: Initialize the harmony memory.} \\
 an initial HM is filled with a population of  Harmony Memory Size (HMS), harmonies are generated randomly and the details of the procedure can be given in Algorithm 
...
%      }
    \caption{Generating new harmony}
\end{algorithm}
