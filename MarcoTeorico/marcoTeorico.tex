...
%Nodo 2==============================================
\node (pro2) [mybox, below of=pro1, yshift=-3.2cm] {
...
%Nodo 3============================================
\node (pro3) [mybox, below of=pro2, yshift=-3.3cm] {
	\begin{minipage}{0.50\textwidth}
		\scriptsize
		 \begin{itemize}
...
%Nodo 4=============================================
\node (pro4) [mybox,below of=pro3, yshift=-3.2cm, xshift=-4.0cm] {
...
%Nodo 5==============================================
\node (pro5) [mybox,below of=pro3, yshift=-3.2cm, xshift=4.0cm] {
