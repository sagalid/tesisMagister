...
Harmonies are generated randomly and the details of the procedure can be given in Algorithm \ref{alg:impr_new_harmony}. According to the process seen above , vectors are generated as follows $(x^1,\ldots,x^{HMS})$. Vectors results , make up a matrix such as that shown in (Figure \ref{mat:sol_mat}):
