...
\begin{figure}[!http]
	\begin{center}
		\includegraphics[scale=0.30]{Introduccion/imagenes/SetCovering.png} %width=0.5\linewidth 
...
\begin{figure}[H]%!http
	\begin{center}
		\includegraphics[scale=0.35]{Introduccion/imagenes/SetCoveringSolved.png}%width=0.5\linewidth
